...
def get_grad_dl(model: nn.Module, dataloader: DataLoader, device,seed:int):
    ...
    for x, y in dataloader:
        ...
        dummy_grad = [p.grad.detach().clone() for p in model.parameters() if p.grad is not None]
        ...
        yield x, y, dummy_grad, mean_var_list
